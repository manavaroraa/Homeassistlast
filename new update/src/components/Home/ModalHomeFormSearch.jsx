        ...
        <CustomModalBody paddingTop="1rem">
          <BoxFormSearch display={formik.isSubmitting ? "none" : "block"}>
            <FormSearch onSubmit={formik.handleSubmit} noValidate>
              <Container>
                <Text color="#333">{lang?.homeFormSearch?.item1}</Text>
              ...
              <Container>
                <Text color="#333">{lang?.homeFormSearch?.item2}</Text>
                {!loading && (
                  <MySelect
                    name="country"
                    placeholder={lang?.homeFormSearch?.placeholder2}
                    styles={{
                      control: (base) => ({
                        ...base,
                        minHeight: "54px",
              ...
              <Container>
                <Text color="#333">{lang?.homeFormSearch?.item3}</Text>
                {!loading && (
                  <Select
