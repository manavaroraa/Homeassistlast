          ...
          <form onSubmit={formik.handleSubmit}>
            <ContentForm>
              ...
              >
                <FormattedMessage
                  id="app.senha"
                  defaultMessage={lang?.login?.passwordLogin}
                />
              </Label>
              <CustomInput
                isInvalid={
              ...
              >
                <LabelButton>
                  <FormattedMessage
                    id="app.fazerLogin"
                    defaultMessage={lang?.login?.buttonLogin}
                  />
                </LabelButton>
              </CustomButton>
            </ContentForm>
          ...
          <BoxLink>
            <LinkCustom onClick={() => props.history.push("/esqueceu-senha")}>
              <FormattedMessage
                ...
                defaultMessage={lang?.login?.textForgotPassword}
              />
            </LinkCustom>
          </BoxLink>
        </Box>
          ...
          <ContentForm>
            ...
            >
              <LabelButton>
                <FormattedMessage
                  id="app.cadastreSe"
                  defaultMessage={lang?.login?.buttonRegister}
                />
              </LabelButton>
            </CustomButton>
          </ContentForm>
