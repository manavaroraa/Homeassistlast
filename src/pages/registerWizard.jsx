...
const Nav = (props) => {
  ...
  for (let i = 1; i <= props.totalSteps; i += 1) {
    ...
    dots.push(
      <span key={`step-${i}`} className={isActive ? "active" : ""}>
        &bull;
      </span>
    );
  }
...
const RegisterWizard = (props) => {
  ...
  const steps_work_home = [
    {
      title: lang?.accountProfile?.personalInfo?.sectionTitle,
      children: <PessonalIdentification />,
    },
    {
      title: lang?.accountProfile?.professionalInfo?.sectionTitle,
      children: <ProfessionalsInformation />,
    },
    {
      title: lang?.accountProfile?.documents?.sectionTitle,
      children: <Documents />,
    },
    {
      title: lang?.accountProfile?.professionalExperience?.sectionTitle,
      children: <ProfessionalExperience />,
    },
    {
      title: lang?.accountProfile?.aditionalInfo?.sectionTitle,
      children: <AdditionalInformations />,
    },
  ];
  const steps_user = [
    {
      title: lang?.accountProfile?.sectionTitle,
      children: <PessonalIdentification />,
    },
  ];
