      ...
      <MyForm onSubmit={formik.handleSubmit} autocomplete="off">
        <Grid>
          ...
          <MyInput
            ...
            label={lang?.accountProfile?.documents?.birthCountry}
            name="country_born"
          ...
          <MyInput
            ...
            label={lang?.accountProfile?.documents?.birthDistrict}
            name="city_born"
          ...
          <MyInput
            ...
            name="father_name"
            label={lang?.accountProfile?.documents?.fatherName}
            placeholder={lang?.accountProfile?.documents?.fatherName}
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
          />
          <MyInput
            ...
            name="mother_name"
            label={lang?.accountProfile?.documents?.motherName}
            placeholder={lang?.accountProfile?.documents?.motherName}
          ...
          <Box display="flex" alignItems="flex-end">
            {formik.values.document_image?.length > 0 ? (
              <Col>
                <Label>{lang?.accountProfile?.documents?.documentCopy}</Label>
                <BoxAvatar>
                  <InputImage
                    type="file"
        ...
        <Grid marginTop="2.5rem">
          ...
          {districtJson?.length > 0 && (
            <Box>
              ...
              {!!formik.errors.state &&
                ...
                !!formik.errors.state && (
                  <MessageError>{lang?.tooltips?.requiredField}</MessageError>
                )}
            </Box>
          )}
          <MyInput
          ...
          <Box>
            <Box display="flex" alignItems="flex-end">
              <Box width="100%">
                <Label>
                  {
                    lang?.accountProfile?.professionalExperience?.availableTime
                      ?.label
                  }
                </Label>
                <CustomSelect
          ...
          {formik.values.photo?.length > 0 ? (
            <Col>
              <Label>{lang?.accountProfile?.documents?.profilePicture}</Label>
              <BoxAvatar>
                <InputImage
                  type="file"
        ...
        <Col marginTop="2rem">
          <Label>{lang?.accountProfile?.aditionalInfo?.hasSocialMedia}</Label>
          <CustomRadio
          ...
          {formik.values.has_social_link === "true" && (
            <Box marginTop="1rem">
              <Label>
                {lang?.accountProfile?.aditionalInfo?.acceptDisclosure}
              </Label>
              <CustomRadio
        ...
        <Grid marginTop="2rem">
          <MyInput
            ...
            width={width >= 1024 ? "94% !important" : "90% !important"}
            label={lang?.accountProfile?.professionalExperience?.level}
            placeholder={lang?.accountProfile?.professionalExperience?.level}
            name="schooling"
          ...
          <Col>
            <Label>
              {lang?.accountProfile?.professionalExperience?.cvFile}
            </Label>
            <BoxAvatar style={{ backgroundColor: "#fff" }}>
              <InputImage
                type="file"
          ...
          {/* <MyInput
            ...
            width={width >= 1024 ? "94% !important" : "90% !important"}
            label={lang?.accountProfile?.professionalExperience?.cvFile}
            placeholder={lang?.accountProfile?.professionalExperience?.cvFile}
            name="cv_link"
          ...
          /> */}
          <Box>
            <Label>{lang?.accountProfile?.aditionalInfo?.driverLicense}</Label>
            <CustomRadio
            ...
            <Col>
              ...
              <CustomRadio
                ...
                options={[
                  {
                    label:
                      lang?.accountProfile?.professionalExperience
                        ?.availableTime?.hourly,
                    value: 1,
                  },
                  {
                    label:
          ...
          <Box>
            <Label>{lang?.accountProfile?.aditionalInfo?.livingPets}</Label>
            <CustomRadio
          ...
          <Box>
            <Label>{lang?.accountProfile?.aditionalInfo?.smoker}</Label>
            <CustomRadio
              name="smoker"
        ...
        <Col marginTop={"1rem"}>
          ...
          <Box marginTop={"1rem"}>
            <MyInput
              ...
              placeholder={lang?.accountProfile?.aditionalInfo?.personalNotes}
