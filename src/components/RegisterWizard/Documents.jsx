...
import { formatFile } from "../../utils/helper";
  ...
  return (
    <MyForm onSubmit={formik.handleSubmit} autocomplete="off">
      <Grid width={width}>
        <Box>
          <LabelWithTooltip
            label={lang?.accountProfile?.documents?.documentCopy}
            infoMessage={lang?.tooltips?.document}
          />
          <Box
            display="flex"
            alignItems="flex-end"
        ...
        <Box>
          <LabelWithTooltip
            label={lang?.accountProfile?.documents?.profilePicture}
            infoMessage={lang?.tooltips?.profilePic}
          />
        ...
        <MyInput
          ...
          infoMessage={lang?.tooltips?.father}
        />
        <MyInput
          isInvalid={
          ...
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          infoMessage={lang?.tooltips?.mother}
        />
        <MyInput
          isInvalid={
          ...
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          infoMessage={lang?.tooltips?.birthState}
        />
        <MyInput
          isInvalid={
